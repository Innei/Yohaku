...
const platformMap = [
  {
    type: 'GH',
    icon: <GitHubBrandIcon {...sx(atoms.text__hash1D2127, atoms.dark_text__hashFFFFFF)} />,
    test: isGithubUrl,
  },
  { type: 'TW', icon: <TwitterIcon />, test: isTwitterUrl },
  {
    type: 'TG',
    icon: <TelegramIcon {...sx(atoms.text__hash2AABEE)} />,
    test: isTelegramUrl,
  },
  {
    type: 'BL',
    icon: <BilibiliIcon {...sx(atoms.text__hash469ECF)} />,
    test: isBilibiliUrl,
  },
  {
    type: 'ZH',
    icon: <ZhihuIcon {...sx(atoms.text__hash0084FF)} />,
    test: isZhihuUrl,
  },
  {
    type: 'WI',
    icon: <WikipediaIcon {...sx(atoms.text_current)} />,
    test: isWikipediaUrl,
  },
  {
    type: 'TMDB',
    icon: <TheMovieDBIcon {...sx(atoms.text__hash0D243F, atoms.dark_text__hash5CB7D2)} />,
    test: isTMDBUrl,
  },
  {
    type: 'Moz',
    icon: <MozillaIcon {...sx(atoms.text__hash8cb4ff)} />,
    test: isMozillaUrl,
  },
  { type: 'Npm', icon: <NpmIcon />, test: isNpmUrl },
  {
    type: 'Figma',
    icon: <FigmaIcon {...sx(atoms.text__hashA259FF)} />,
    test: isFigmaUrl,
  },
  {
    type: 'XHS',
    icon: <XiaoHongShuIcon {...sx(atoms.text__hashFE2442)} />,
