  ...
  return (
    <a
      ...
      className={clsxm(
        ...
        'yohaku-link-card group relative isolate my-4 block w-full max-w-[38rem] cursor-pointer overflow-hidden rounded-xl bg-neutral-1 px-6 py-4 text-neutral-9 no-underline ring-1 ring-border not-prose transition-colors duration-200 dark:bg-neutral-2',
        className,
      )}
    >
      <InkWash />
