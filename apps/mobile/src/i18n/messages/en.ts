...
export const en = {
  ...
  search: {
    entry: 'Search',
    placeholderPosts: 'Search posts',
    placeholderNotes: 'Search notes',
    placeholderThinking: 'Search musings',
    recents: 'Recent',
    clearRecents: 'Clear',
    empty: 'No results',
    emptyHint: 'Try a different keyword',
    offline: 'Offline — only downloaded content',
  ...
  detail: {
    ...
    codeCopy: 'Copy',
    codeCopied: 'Copied',
    codeExpand: 'Expand · {count} lines',
    filePreviewUnavailable: 'Preview unavailable',
    filePreviewDownload: 'Download to view',
    filePreviewTruncated: 'Previewing the first {size}',
    fileDownloadFull: 'Download the full file',
  ...
  me: {
    ...
    version: 'Version',
    versionEmbedded: '{version} · embedded',
    versionOta: '{version} · OTA',
    blog: 'Blog',
    pages: 'Pages',
    statPosts: 'posts',
    statWordsUnit: 'k words',
    statDays: 'days',
  ...
  dev: {
    ...
    ota: 'OTA',
    otaCheck: 'Check for update',
    otaApply: 'Apply update',
    otaIdle: 'Not checked',
    otaChecking: 'Checking…',
    otaReady: 'Downloaded — tap apply',
    otaUnavailable: 'Already up to date',
